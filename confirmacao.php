...
<body>
    <div class="main">
        ...
        <form action="php/confirmacao.php" method="POST" required>
            <div class="inputBox">
                <input class="inputUser" type="text" name="code" minlength="6" maxlength="6" id="code" autocomplete="off" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
